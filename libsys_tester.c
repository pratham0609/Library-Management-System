...
void process_line(char *test_case)
{
        ...
        else
        {
            ...
            if (expected_status == 0)
            {
                if (testBook.isbn == isbn &&
                    strcmp(testBook.title, "YOGI") == 0 &&
                    strcmp(testBook.author, "yoganand") == 0 &&
                    testBook.price == 100.50)
                {
                    TREPORT("PASS", "");
                }
    ...
    else if (!strcmp(command, "SEARCH_BOOK_TITLE"))
    {
        ...
        else
        {
            ...
            if (expected_status == 0)
            {
                if (testBook.isbn == 10000 &&
                    strcmp(testBook.title, title) == 0 &&
                    strcmp(testBook.author, "yoganand") == 0 &&
                    testBook.price == 100.50)
                {
                    TREPORT("PASS", "");
    ...
    else if (!strcmp(command, "SEARCH_STUDENT_NAME"))
    {
        ...
        if (status != expected_status)
        {
            sprintf(info, "search key: %s; Got status %d", name, status);
            TREPORT("FAIL", info);
        }
        else
        {
            ...
            if (expected_status == 0)
            {
                if (testStudent.rollno == 1 &&
                    strcmp(testStudent.name, name) == 0 &&
                    strcmp(testStudent.address, "#219") == 0 &&
                    testStudent.cgpa == 9.5)
                {
                    TREPORT("PASS", "");
                }
